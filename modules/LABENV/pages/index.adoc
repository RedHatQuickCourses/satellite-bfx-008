...
. **Search** for the catalog entry: **https://catalog.demo.redhat.com/catalog?item=babylon-catalog-prod/pert.satellite6-17-bfx.prod&utm_source=webapp&utm_medium=share-link[Product Enablement: Red Hat Satellite 6.17 Break-fix lab]**.
